...
public class pruebaDAO 
{
	...
	public static void main(String[] args) throws UserNotFoundException, IncorrectPasswordException 
	{
		...
		System.out.println("Prueba de getProfesoresOrderBy");
		Set<Profesor> profesores = dao.getProfesoresOrderByNombre(56712038);
		System.out.println(" 	Datos basicos de los profesores: ");	
		...
		List<Evaluacion> evaluaciones = dao.getEvaluacionesOrderedByAsignatura(56712038);

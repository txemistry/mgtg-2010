...
<html>
	...
	<head>
	    <link href="<s:url value='/css/main.css'/>" rel="stylesheet" type="text/css"/>
	   	<title><s:text name="label.notas.para.estudiante"/> "<s:property value="#session.nombre"/>"</title>

	</head>
	
	<body>
		<div class="titleDiv"><s:text name="application.title"/></div>
		<h1><s:text name="label.notas.para.estudiante"/> "<s:property value="#session.nombre"/>"</h1>
		...
		<table class="borderAll">
			<tr>
				<th><s:text name="label.asignatura"/></th>
